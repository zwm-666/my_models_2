...
def _round_result(value: Any) -> float:
        ...
        rows.append(
            {
                ...
                "train_loss": _round_result(item.get("train_loss", 0.0)),
                "train_accuracy": _round_result(item.get("train_accuracy", 0.0)),
                "train_macro_f1": _round_result(item.get("train_macro_f1", 0.0)),
                "val_accuracy": _round_result(item.get("val_accuracy", 0.0)),
                "val_macro_f1": _round_result(item.get("val_macro_f1", 0.0)),
                "val_class0_recall": _round_result(item.get("val_class0_recall", 0.0)),
                "train_holdout_macro_f1": _round_result(item.get("train_holdout_macro_f1", 0.0)),
                "train_val_gap_penalty": _round_result(item.get("train_val_gap_penalty", 0.0)),
                "selection_score": _round_result(item.get("selection_score", 0.0)),
                "lr": _round_result(item.get("lr", 0.0)),
            }
        )
    return rows
